 ...
 */
public class ReservationRecapPanel extends JPanel {
	...
	private VosReservationsPanel reservationPanel;
	
	
	public ReservationRecapPanel(VosReservationsPanel reservationPanel, Creneau creneau) {
